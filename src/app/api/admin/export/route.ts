...
const DATASETS: Record<string, DatasetConfig> = {
  ...
  productos: {
    ...
    hoja: "Productos",
    tabla: "productos",
    select: "id, nombre, slug, categoria, descripcion_corta, precio_referencial, destacado, activo, created_at",
    dateField: "created_at",
    columns: [
      { header: "Producto", key: "nombre" },
      { header: "Categoría", key: "categoria" },
      { header: "Descripción", key: "descripcion", width: 46 },
      { header: "Precio ref.", key: "precio", width: 13 },
    ...
    map: (r) => ({
      ...
      descripcion: r.descripcion_corta as string,
      precio: r.precio_referencial as number,
