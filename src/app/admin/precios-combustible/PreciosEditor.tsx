        ...
        return (
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50/60">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">Código interno</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <span
            ...
            <div className="px-6 py-5 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              ...
              {/* Unidad */}
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-semibold text-slate-600 uppercase tracking-wider">Unidad</label>
                <select
                  value={st.unit}
                  onChange={(e) => update(fp.id, "unit", e.target.value)}
                  className="border border-slate-200 rounded-xl px-3 py-2.5 text-sm text-[#0a1628] focus:outline-none focus:ring-2 focus:ring-[#f5a623]/40 focus:border-[#f5a623] bg-white"
                >
              ...
              {/* Actualizado por */}
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-semibold text-slate-600 uppercase tracking-wider">Actualizado por</label>
                <input
                  type="text"
                  value={st.updated_by}
              ...
              {/* Color acento */}
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-semibold text-slate-600 uppercase tracking-wider">Color acento</label>
              ...
              {/* Orden */}
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-semibold text-slate-600 uppercase tracking-wider">Orden de display</label>
                <input
                  type="number"
                  min={0}
            ...
            {/* Save row */}
            <div className="px-6 py-4 border-t border-slate-100 flex items-center justify-between gap-4 bg-slate-50/40">
              {res && (
                <span
