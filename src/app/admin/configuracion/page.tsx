  ...
  return (
    <div className="p-4 sm:p-6 lg:p-7 max-w-3xl mx-auto admin-rise">
      ...
      <div className="mt-6 pt-6 border-t border-slate-100">
        <Link href="/admin/usuarios" className="admin-card p-5 flex items-center justify-between gap-4 hover:border-[#1a6b3c]/40 transition-colors group">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#f5a623]/12 border border-[#f5a623]/20 rounded-xl flex items-center justify-center shrink-0">
              <Users className="w-5 h-5 text-[#b87608]" />
            </div>
            <div>
          ...
          <ArrowRight className="w-5 h-5 text-slate-400 group-hover:text-[#1a6b3c] group-hover:translate-x-0.5 transition-all shrink-0" />
        </Link>
      </div>
    </div>
  );
