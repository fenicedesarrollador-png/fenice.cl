...
import {
  ...
  TrendingUp, Sparkles, Clock, Truck, Clapperboard,
} from "lucide-react";
...
export default async function AdminDashboard() {
  let stats = {
    ...
    flotaVehiculos: 0, videosActivos: 0,
  };
  ...
  try {
    ...
    const [
      ...
      cotRes, cotNuevasRes,
      blogRes, eventosRes, promosRes, clientesRes, flotaVehiculosRes, videosActivosRes,
      ...
      supabase.from("website_videos").select("id", { count: "exact", head: true }).eq("is_active", true),
    ...
    stats = {
      ...
      videosActivos: videosActivosRes.count ?? 0,
    };
  ...
  const modules = [
    ...
    { label: "Videos activos", value: stats.videosActivos, href: "/admin/videos", icon: Clapperboard },
  ];
