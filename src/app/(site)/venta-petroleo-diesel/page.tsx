...
const pageSchema = {
  ...
  description: "Venta y distribución de petróleo diesel para industria, construcción y empresas en la Región Metropolitana de Chile.",
...
const faqVenta = [
  {
    q: "¿Cuánto cuesta el litro de petróleo diesel para empresas?",
    a: "El precio varía según el volumen, frecuencia y condiciones de entrega. Cotiza directamente con nosotros para obtener el precio más conveniente para tu operación.",
  },
  {
    q: "¿Qué tipos de diesel venden?",
    a: "Distribuimos petróleo diésel estándar grado 3 para uso industrial, transporte y generación eléctrica. Pregunta por disponibilidad de grados especiales.",
  },
  {
    q: "¿Entregan factura electrónica?",
    a: "Sí. Emitimos factura electrónica en cada venta, con todos los datos requeridos por tu área de compras y contabilidad.",
  },
  {
    q: "¿Cómo compro petróleo diesel para mi empresa?",
    a: "Contáctanos por WhatsApp o mediante el formulario de cotización. Te respondemos el mismo día con precio, disponibilidad y condiciones de entrega.",
  },
];
