...
export default function GraciasPage() {
  return (
    <>
      {/* Conversion event for Google Ads — fires on page load */}
      <script
        dangerouslySetInnerHTML={{
          __html: `if(typeof gtag !== 'undefined'){gtag('event','conversion',{'send_to':'AW-XXXXXXXXX/AbCdEfGhIjK_FORMULARIO'});}`,
        }}
      />
      ...
      <section className="min-h-[70vh] flex items-center justify-center py-20 bg-white">
        <div className="max-w-xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <WhatsAppButton mensaje="Hola, acabo de enviar un formulario de cotización en fenice.cl." />
            <Link
              href="/"
