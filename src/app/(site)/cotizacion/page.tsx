...
export default function CotizacionPage() {
  return (
    <>
      {/* Hero strip */}
      <section className="bg-[#0a1628] py-14 relative overflow-hidden" data-analytics-section="cotizacion_hero">
      ...
      {/* Main */}
      <section className="py-16 bg-slate-50" data-analytics-section="cotizacion">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-10">
            {/* Form */}
            <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200 shadow-sm p-8" data-analytics-section="formulario_cotizacion">
              <CotizacionForm />
            </div>
              ...
              <div className="bg-[#0a1628] rounded-2xl p-6 text-white">
                ...
                <div className="space-y-3">
                  <a
                    ...
                    data-analytics-id="cotizacion_whatsapp_directo"
                    data-analytics-label="WhatsApp directo"
                  ...
                  <a
                    ...
                    data-analytics-id="cotizacion_telefono_directo"
