...
const staticRoutes: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE_URL}/venta-petroleo-diesel`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.95 },
  { url: `${BASE_URL}/petroleo-a-domicilio`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.95 },
  { url: `${BASE_URL}/empresas-faenas-flotas`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
  ...
  { url: `${BASE_URL}/cobertura`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.85 },
