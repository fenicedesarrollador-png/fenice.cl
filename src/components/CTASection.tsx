...
export default async function CTASection({
  ...
  return (
    <section className="py-16 bg-slate-900" data-analytics-section="cta">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-8 lg:p-12 relative overflow-hidden">
          ...
          <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="text-center lg:text-left">
              <h2 className="text-2xl lg:text-3xl font-bold text-white mb-2">{heading}</h2>
              <p className="text-orange-100 text-sm lg:text-base">{subheading}</p>
            </div>
            <div className="flex flex-col sm:flex-row items-center gap-3 shrink-0">
              <a
                ...
                className="inline-flex items-center justify-center gap-2.5 bg-white text-orange-600 hover:bg-orange-50 font-semibold px-6 py-3 rounded-xl transition-colors text-sm shadow-sm"
              >
              ...
              <Link
                ...
                data-analytics-label="Formulario"
                data-analytics-cta="lead_form"
                className="inline-flex items-center justify-center gap-2 bg-orange-600/30 hover:bg-orange-600/50 border border-white/20 text-white font-semibold px-6 py-3 rounded-xl transition-colors text-sm"
              >
                Formulario <ArrowRight className="w-4 h-4" />
              </Link>
              <a
                ...
                className="inline-flex items-center justify-center gap-2 text-white/80 hover:text-white font-medium text-sm transition-colors"
              >
