        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-[70px]">
            ...
            <nav className="hidden xl:flex items-center gap-0.5">
              <Link href="/" className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-[#0a1628] rounded-lg hover:bg-slate-50 transition-all whitespace-nowrap">
                Inicio
              </Link>
              ...
              >
                <button className="flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-slate-600 hover:text-[#0a1628] rounded-lg hover:bg-slate-50 transition-all whitespace-nowrap">
                  Servicios
                ...
                {servicesOpen && (
                  <div className="absolute top-full left-0 mt-1 w-80 bg-white rounded-2xl shadow-2xl border border-slate-100 py-3 z-50">
                    ...
                    <div className="mx-4 mt-2 pt-2 border-t border-slate-100">
                      <Link href="/venta-petroleo-diesel" className="flex items-center gap-2 text-xs font-semibold text-[#f5a623] hover:text-[#d4891a] transition-colors py-1">
                        <Fuel className="w-3.5 h-3.5" /> Venta de Petróleo Diésel
                      </Link>
                      <Link href="/petroleo-a-domicilio" className="flex items-center gap-2 text-xs font-semibold text-[#f5a623] hover:text-[#d4891a] transition-colors py-1 mt-0.5">
              ...
              <Link href="/nosotros" className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-[#0a1628] rounded-lg hover:bg-slate-50 transition-all whitespace-nowrap">
                Nosotros
              </Link>
              <Link href="/cobertura" className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-[#0a1628] rounded-lg hover:bg-slate-50 transition-all whitespace-nowrap">
                Cobertura
              </Link>
              <Link href="/empresas-faenas-flotas" className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-[#0a1628] rounded-lg hover:bg-slate-50 transition-all whitespace-nowrap">
                Empresas / Faenas / Flotas
              </Link>
              <Link href="/preguntas-frecuentes" className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-[#0a1628] rounded-lg hover:bg-slate-50 transition-all whitespace-nowrap">
                FAQ
              </Link>
              <Link href="/contacto" className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-[#0a1628] rounded-lg hover:bg-slate-50 transition-all whitespace-nowrap">
                Contacto
              </Link>
            </nav>
        ...
        {open && (
          <div className="xl:hidden border-t border-slate-100 bg-white">
            <div className="max-w-7xl mx-auto px-4 py-4 space-y-1">
              <Link href="/" className="block px-3 py-2.5 rounded-lg text-sm font-medium text-slate-700 hover:bg-slate-50" onClick={() => setOpen(false)}>Inicio</Link>
              ...
              <Link href="/venta-petroleo-diesel" className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[#f0faf4]" onClick={() => setOpen(false)}>
              ...
              <Link href="/petroleo-a-domicilio" className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[#f0faf4]" onClick={() => setOpen(false)}>
              ...
              <div className="flex items-center gap-2 px-3 py-2 text-sm text-slate-500">
                ...
                <a href={`tel:${config.telefono}`} className="font-medium hover:text-[#f5a623]">{config.telefono}</a>
              </div>
            </div>
          </div>
        )}
