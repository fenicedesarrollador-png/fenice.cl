        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a href={`tel:${config.telefono}`} className="hover:text-[#f5a623] transition-colors">
                  {config.telefono}
                </a>
              </li>
              <li className="flex items-center gap-2.5">
                <Mail className="w-4 h-4 text-[#f5a623] shrink-0" />
                <a href={`mailto:${config.email}`} className="hover:text-[#f5a623] transition-colors text-xs break-all">
                  {config.email}
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {SERVICIOS.map((s) => (
                <li key={s.slug}>
                  <Link href={`/servicios/${s.slug}`} className="flex items-center gap-1.5 text-sm hover:text-[#f5a623] transition-colors group">
              ...
              <li>
                <Link href="/venta-petroleo-diesel" className="flex items-center gap-1.5 text-sm hover:text-[#f5a623] transition-colors group">
                  <span className="w-1 h-1 rounded-full bg-[#f5a623]/40 group-hover:bg-[#f5a623] transition-colors" />
                  Venta de Petróleo Diésel
                </Link>
              </li>
              <li>
                <Link href="/petroleo-a-domicilio" className="flex items-center gap-1.5 text-sm hover:text-[#f5a623] transition-colors group">
                  <span className="w-1 h-1 rounded-full bg-[#f5a623]/40 group-hover:bg-[#f5a623] transition-colors" />
                  Petróleo a Domicilio
                </Link>
              </li>
              <li>
                <Link href="/empresas-faenas-flotas" className="flex items-center gap-1.5 text-sm hover:text-[#f5a623] transition-colors group">
                  <span className="w-1 h-1 rounded-full bg-[#f5a623]/40 group-hover:bg-[#f5a623] transition-colors" />
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm mb-6">
              {[
                ...
                <li key={item.href}>
                  <Link href={item.href} className="flex items-center gap-1.5 hover:text-[#f5a623] transition-colors group text-sm">
