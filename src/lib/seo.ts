...
export const CORE_KEYWORDS = [
  ...
  "kerosene para calefacción región metropolitana",
  ...
  "despachos programados de combustible",
  "despacho de combustible de emergencia",
  "suministro de diesel industrial",
];
...
export function organizationSchema() {
  return {
    ...
    taxID: SITE_CONFIG.rut,
    foundingDate: SITE_CONFIG.fundacion,
    address: {
      "@type": "PostalAddress",
    ...
    contactPoint: [
      ...
      },
      {
        ...
        email: SITE_CONFIG.email_finanzas,
        areaServed: "CL",
        availableLanguage: "es",
      },
    ],
